        ...
        <div class="max-w-3xl mx-auto w-full">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="flex items-start gap-4">
                    <div class="avatar w-16 h-16 text-xl avatar-orange">JD</div>
                    <div class="flex-1 grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Prénom</label>
                            <input type="text" value="Jean" disabled class="w-full border border-gray-200 bg-gray-50 rounded-md px-3 py-2 text-sm text-gray-500 outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Nom</label>
                            <input type="text" value="Dupont" disabled class="w-full border border-gray-200 bg-gray-50 rounded-md px-3 py-2 text-sm text-gray-500 outline-none">
                        </div>
                        <div class="col-span-2">
                            <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Email</label>
                            <input type="email" value="j.dupont@chimay-gestion.be" disabled class="w-full border border-gray-200 bg-gray-50 rounded-md px-3 py-2 text-sm text-gray-500 outline-none">
