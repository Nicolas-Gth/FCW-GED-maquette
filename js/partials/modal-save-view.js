    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        ...
        <form class="px-6 py-5 space-y-4" onsubmit="event.preventDefault(); saveView();">
            <div>
                ...
                <input id="save-view-name" type="text" required placeholder="Ex: Mes CA 2026" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary">
