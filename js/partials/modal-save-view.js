  ...
  <path d="m6 6 12 12" /></svg>
        ...
        <form class="px-6 py-5 space-y-4" onsubmit="event.preventDefault(); saveView();">
            ...
            <div class="pt-4 border-t border-gray-100 flex justify-end gap-3">
                <button type="button" onclick="toggleModal('modal-save-view', false)" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 text-sm font-medium">Annuler</button>
